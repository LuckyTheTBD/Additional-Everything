execute if score @s la matches 0 run effect give @s minecraft:water_breathing 1 0 true
execute if score @s la matches 0 run effect give @s minecraft:dolphins_grace 1 0 true
