...
execute if score #c.max_health c.heal matches ..0 run return run function libraries:custom_heal/full_heal
...
function libraries:custom_heal/set_hp with storage custom_heal:amount amount
...
advancement revoke @s only libraries:custom_heal/reset_heal